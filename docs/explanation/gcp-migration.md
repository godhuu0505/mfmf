...
5. **削除の後にもう一度プレフィックスを確認し、残っていれば消す**

> **「有効期限が切れるまで待つ」だけでは足りません。** 期限の直前に始まって
> **本文の送信中に停滞している PUT は、期限を過ぎても打ち切られません**。しかも
> **アップロード中のオブジェクトは完了するまで一覧に現れない**ので、
> **確認の時点ではプレフィックスが空に見えます**。だから待つ対象は
> 「URL の有効期限」ではなく **「予約の決着」**であり、さらに **削除後の再確認**を
> 最後に置きます（手順 3 と 5）。
