...
function statusOf(link: ShareLink): { label: string; tone: string } {
  if (link.revoked_at) return { label: "失効済み", tone: "bg-slate-100 text-slate-500" };
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-6">
        ...
        <h1 className="mb-1 text-xl font-bold text-slate-900">共有リンク</h1>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex-1 min-w-[8rem]">
                <label htmlFor="from_date" className={labelClass}>
                  開始日<span className="ml-1 text-xs font-normal text-slate-400">（任意）</span>
                </label>
                <input id="from_date" name="from_date" type="date" className={inputClass} />
              </div>
              <div className="flex-1 min-w-[8rem]">
                <label htmlFor="to_date" className={labelClass}>
                  終了日<span className="ml-1 text-xs font-normal text-slate-400">（任意）</span>
                </label>
